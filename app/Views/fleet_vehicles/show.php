...
<nav class="capital-tabs" aria-label="Vehicle detail sections"><a href="#overview">Overview</a><a href="#vehicle-health">Vehicle Health</a><a href="#vehicle-damage">Damage &amp; Condition</a><a href="#acquisition">Acquisition</a><a href="#financing">Financing</a><a href="#performance">Financial Performance</a><a href="#documents">Notes &amp; Documents</a></nav>
...
<?= view('fleet_vehicles/components/vehicle_damage', ['vehicle' => $vehicle, 'vehicleDamage' => $vehicleDamage, 'notice' => $vehicleDamageNotice, 'errors' => $vehicleDamageErrors, 'form' => $vehicleDamageForm, 'formData' => $vehicleDamageData]) ?>
